      ...
      <FadeIn>
        <div className="mx-auto max-w-5xl px-6 py-28">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Link
              href="/request-invite"
              className="inline-flex shrink-0 items-center justify-center rounded-md bg-navy-800 px-6 py-3 text-base font-medium text-white transition-colors hover:bg-navy-700"
            >
              Request an invite
            </Link>
          </div>
